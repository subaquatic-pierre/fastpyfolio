...
export default function Document() {
  return (
    <Html>
      <Head>
        <meta property="og:title" content="Nebula Nexus" />
        <meta property="og:description" content="Software Engineering | Cloud Computing" />
        <meta name="description" content="Software Engineering | Cloud Computing" />
        <meta charSet="utf-8" />
