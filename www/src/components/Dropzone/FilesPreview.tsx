...
import { List, ListItemText, ListItem, CardMedia, Button } from '@mui/material';
  ...
  return (
    ...
    >
      {files.map((file, index) => {
        ...
        const customFile = files[index] as CustomFile;
        ...
        return (
          ...
          >
            ...
            <Button sx={{ mr: 1 }} size="small" download={customFile.name} href={customFile.url}>
              Download
            </Button>
