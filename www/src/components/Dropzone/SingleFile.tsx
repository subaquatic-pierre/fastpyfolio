        ...
        return (
          ...
          >
            <Box
              ...
              sx={{ objectFit: 'contain', maxWidth: '100%', maxHeight: '100%', objectPosition: 'center center' }}
              onLoad={() => {
    ...
    <Box sx={{ width: '100%', ...sx }}>
      ...
      >
        ...
        <PlaceholderContent
          ...
          title={title}
          document={document && file && file.length > 0 ? file[0].name : undefined}
        />
        {!document && thumbs()}
      </DropzoneWrapper>
      ...
      {file && file.length > 0 && (
        <Stack direction="row" justifyContent="flex-end" sx={{ mt: 1.5 }}>
          ...
          {!noRemove && (
            <Button variant="contained" size="small" color="error" onClick={onRemove}>
              Remove
            </Button>
          )}
        </Stack>
