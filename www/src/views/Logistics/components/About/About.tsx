          ...
          <Grid item container alignItems={'center'} xs={12} md={6} data-aos="fade-up">
            <Container paddingLeft={'0 !important'}>
              <Box>
                ...
                <Box marginBottom={2}>
                  <Typography component={'span'} variant="h4" sx={{ fontWeight: 700, color: 'common.white' }}>
                    Monitor and analyze usage patterns.
                  </Typography>
                </Box>
                <Typography variant="h6" component="p" sx={{ color: 'common.white' }}>
                  Keep track of what's happening with your data, change permissions, and run reports against your data anywhere in the
                  world.
                  <br />
            ...
            >
              ...
              <CardActions sx={{ paddingBottom: 2 }}>
                <ListItem component="div" disableGutters sx={{ padding: 0 }}>
                  ...
                  <ListItemText sx={{ margin: 0 }} primary={'Clara Bertoletti'} secondary={'MUI lover'} />
                </ListItem>
              </CardActions>
            </Box>
          </Grid>
