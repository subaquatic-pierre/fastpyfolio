...
const mock = [
  {
    ...
    subtitle:
      'Expertise honed in crafting robust and scalable solutions. From innovative architecture to reusable components, mastery is evident.',
    icon: (
  ...
  {
    title: 'Pioneering Design Solutions',
    subtitle: 'Pioneering design solutions shaped by the latest trends. Embracing modernity, minimalism, and visual excellence.',
    icon: (
      <svg height={24} width={24} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path
          strokeLinecap="round"
  ...
  },
  {
    ...
    subtitle: 'In-depth documentation ensures clarity. No guesswork required, just clear guidance and understanding.',
    icon: (
      <svg height={24} width={24} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
const Trucking = (): JSX.Element => {
  ...
  const LeftSide = () => (
    <List disablePadding>
      {mock.map((item, index) => (
        <ListItem key={index} disableGutters data-aos="fade-up" data-aos-delay={index * 300} data-aos-offset={100} data-aos-duration={600}>
          <ListItemAvatar>
    ...
    <Box>
      <Box marginBottom={4}>
        ...
        <Typography variant="h6" component="p" align={'center'}>
          Navigating complex decision-making hurdles in cloud-based solutions.
        </Typography>
      </Box>
